    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                <div class="single__team">
                    <div class="teamarea__img">
                        <img loading="lazy"  src="{{ asset('/') }}website/img/team/team__1.png" alt="team">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                <div class="single__team">
                    <div class="teamarea__img">
                        <img loading="lazy"  src="{{ asset('/') }}website/img/team/team__2.png" alt="team">
                        <div class="teamarea__icon">
                            <ul>
                                <li>
                                    <a href="#"> <i class="icofont-facebook"></i></a>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                <div class="single__team">
                    <div class="teamarea__img">
                        <img loading="lazy"  src="{{ asset('/') }}website/img/team/team__3.png" alt="team">
                        <div class="teamarea__icon">
                            <ul>
                                <li>
                                    <a href="#"><i class="icofont-facebook"></i></a>
        ...
        <div class="row">
                    ...
                    <div class="testimonialarea__paragraph__3 ">
                        ...
                        <div class="testimonialarea__person__3">
                            <div class="testimonial__img__3">
                                <img loading="lazy"  src="{{ asset('/') }}website/img/testimonial/testi_2.png" alt="">
                            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                <div class="testimonial__group__img" data-tilt>
                    <img loading="lazy"  src="{{ asset('/') }}website/img/testimonial/testi__group__1.png" alt="">
                </div>
            </div>
        </div>
    </div>
